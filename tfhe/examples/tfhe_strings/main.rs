...
mod test {
    use crate::{
        FheAsciiChar, FheSplit, FheString, FheStrip, MyClientKey, MyServerKey, STRING_PADDING,
    };
    ...
    fn replacen() {
        ...
        let my_new_string =
            my_server_key.replacen(&my_string, &from, &to, n, &public_key, num_blocks);
    ...
    fn concatenate() {
        ...
        let my_string1 =
            my_client_key.encrypt(my_string1_plain, STRING_PADDING, &public_key, num_blocks);
        let my_string2 =
            my_client_key.encrypt(my_string2_plain, STRING_PADDING, &public_key, num_blocks);
        let my_string_upper =
            my_server_key.concatenate(&my_string1, &my_string2, &public_key, num_blocks);
    ...
    fn split() {
        ...
        let fhe_split = my_server_key.split(&my_string, &pattern, &public_key, num_blocks);
    ...
    fn split_inclusive() {
        ...
        let fhe_split =
            my_server_key.split_inclusive(&my_string, &pattern, &public_key, num_blocks);
        let plain_split = FheSplit::decrypt(fhe_split, &my_client_key, STRING_PADDING);
    ...
    fn split_terminator() {
        ...
        let fhe_split =
            my_server_key.split_terminator(&my_string, &pattern, &public_key, num_blocks);
        let plain_split = FheSplit::decrypt(fhe_split, &my_client_key, STRING_PADDING);
    ...
    fn split_ascii_whitespace() {
        ...
        let fhe_split = my_server_key.split_ascii_whitespace(&my_string, &public_key, num_blocks);
        let plain_split = FheSplit::decrypt(fhe_split, &my_client_key, STRING_PADDING);
    ...
    fn rsplit() {
        ...
        let fhe_split = my_server_key.rsplit(&my_string, &pattern, &public_key, num_blocks);
        let plain_split = FheSplit::decrypt(fhe_split, &my_client_key, STRING_PADDING);
